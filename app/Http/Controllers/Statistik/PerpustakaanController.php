...
class PerpustakaanController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = LayananPerpustakaan::orderBy('periode', 'desc')
        ->paginate(12);
    ...
    public function store(Request $request)
    {
        ...
        if (LayananPerpustakaan::where('periode', $periode)->exists()) {
            return back()
        ...
        return redirect()
            ->route('statistik.perpustakaan.index')
    ...
    {
        $data = LayananPerpustakaan::findOrFail($id);
    ...
    if (LayananPerpustakaan::where('periode', $periode)
        ->where('id', '!=', $id)
        ->exists()) {
