  ...
  <style>
    * {
    ...
    body {
      ...
      background: linear-gradient(135deg, #002B6A 0%, #003d8a 50%, #0066CC 100%);
      min-height: 100vh;
      display: flex;
      align-items: center;
...
<body>
  ...
  <div class="error-container">
    ...
    <p class="error-message">
      Maaf, halaman yang Anda cari tidak ada atau telah dipindahkan. Silakan cek kembali URL atau kembali ke halaman utama.
    </p>
