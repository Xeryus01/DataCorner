...
<head>
    ...
    <title>Admin — Datapedia BPS</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .role-badges { display: flex; flex-wrap: wrap; gap: 6px; margin-bottom: 1.25rem; }
        .role-badge { font-size: 10px; font-weight: 700; padding: 4px 10px; border-radius: 20px; text-transform: uppercase; letter-spacing: 0.04em; }
        .role-admin { background: #dbeafe; color: #1d4ed8; }
        .role-operator { background: #dcfce7; color: #16a34a; }
        .role-magang { background: #fff7ed; color: #ea580c; }
    ...
    <div class="login-wrap">
        <div class="login-card">
            <div class="card-header">
                ...
                <div class="header-sub">Masuk untuk mengelola sistem</div>
            </div>
            <div class="card-body">
                <form action="{{ route('prosesloginAdmin') }}" method="POST">
                    ...
                    <div class="role-badges">
                        <span class="role-badge role-admin"><i class="ti ti-user-shield" style="font-size:10px"></i> Admin</span>
                        <span class="role-badge role-operator"><i class="ti ti-edit" style="font-size:10px"></i> Operator</span>
                        <span class="role-badge role-magang"><i class="ti ti-briefcase" style="font-size:10px"></i> Magang</span>
                    </div>
                    <div class="form-group">
                        <label class="form-label" for="email">Email</label>
                        <div class="field-box">
                            <div class="field-icon-left"><i class="ti ti-mail"></i></div>
                            <input type="email" class="field-input" name="email" id="email" placeholder="admin@example.com" autocomplete="email" value="{{ old('email') }}" required>
                        </div>
                    ...
                    <button type="submit" class="btn-submit" id="submitBtn"><i class="ti ti-login" style="font-size:16px"></i> <span id="btnText">Masuk ke Panel</span></button>
                    <div class="alt-row">Bukan admin? <a href="{{ route('loginKonsultan') }}" class="link">Ke Login Konsultan</a></div>
