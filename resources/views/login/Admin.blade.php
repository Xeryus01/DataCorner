  ...
  <main class="w-full max-w-5xl mx-auto rounded-3xl flex flex-col lg:flex-row card-shadow bg-white overflow-hidden">
    ...
    <section class="w-full lg:w-1/2 gradient-bg px-8 py-12 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div class="relative text-center fade-in-up">
        <h1 class="text-white font-bold text-4xl lg:text-5xl mb-4">Selamat Datang Admin</h1>
        <div class="w-20 h-1 bg-white mx-auto mb-6 rounded-full"></div>
        <p class="text-white/90 text-lg mb-8 max-w-xs">Masukkan Email dan Password untuk mengelola sistem</p>
        <div class="fade-in-up delay-300">
          <img src="{{ asset('image/login.png') }}" alt="Admin Login Illustration"
    ...
    <section class="w-full lg:w-1/2 bg-white p-8 lg:p-12 flex flex-col justify-center">
      <form action="{{ route('prosesloginAdmin') }}" method="POST" class="w-full max-w-md mx-auto">
        @csrf
        ...
        <div class="text-center mb-8 fade-in-up delay-100">
          ...
          <p class="text-gray-600">Akses panel admin dengan aman</p>
        </div>
        ...
        <div class="mb-6 fade-in-up delay-200">
          ...
          <div class="relative">
            ...
            <input type="email" name="email" id="email" placeholder="admin@example.com" autocomplete="email"
        ...
        <div class="mb-8 fade-in-up delay-300">
          ...
          <div class="relative">
            ...
            <button type="button" onclick="toggleAdminPassword()" class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors duration-200" aria-label="Toggle password visibility">
        ...
        <div class="text-center fade-in-up delay-400">
          <p class="text-gray-600">
            Bukan Admin?
            <a href="{{ route('loginKonsultan') }}" class="text-primary hover:underline font-semibold ml-1 transition-colors duration-300">
              Ke Login Konsultan
            </a>
          </p>
        </div>
