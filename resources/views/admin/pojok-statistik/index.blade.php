    ...
    <div class="w-full bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-blue-300 p-4 flex items-center justify-between">
            ...
            <h2 class="text-xl font-bold text-blue-800">
                Data Statistik Pengunjung Pojok Statistik
            </h2>

            <a href="{{ route('statistik.pojok-statistik.create') }}"
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="p-3 border border-gray-200">
                            <div class="flex justify-center gap-2">
                                <a href="{{ route('statistik.pojok-statistik.edit', $item->id) }}"
                                    class="px-3 py-1 bg-yellow-300 hover:bg-yellow-400 text-yellow-800 rounded text-sm">
                                    Edit
                                </a>

                                <form action="{{ route('statistik.pojok-statistik.destroy', $item->id) }}"
                    ...
                    <tr>
                        <td colspan="9"
                            ...
                            Belum ada data statistik pojok statistik.
                        </td>
                    </tr>
