...
<div class="page-header-row">
    <div>
        <div class="page-title">Tambah Data Pengunjung Pojok Statistik</div>
        <div class="page-sub">Form input data Pengunjung Pojok Statistik</div>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        <div class="card-header-left">
            <div class="card-title"><i class="ti ti-map-pin"></i>Form Statistik Pojok Statistik</div>
        </div>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('statistik.pojok-statistik.store') }}" method="POST">
            @csrf
            ...
            <div class="form-actions" style="justify-content:flex-end">
                <a href="{{ route('statistik.pojok-statistik.index') }}" class="btn-ghost">Batal</a>
