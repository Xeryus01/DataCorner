    ...
    <div class="w-full bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="bg-blue-300 px-6 py-5">
            <h2 class="text-2xl font-bold text-blue-900">
                Tambah Data Pengunjung Layanan Konsultasi Statistik
            </h2>
            <p class="text-sm text-blue-800 mt-1">
                Form input data pengunjung layanan konsultasi statistik.
            </p>
        </div>

        <form action="{{ route('statistik.konsultasi-statistik.store') }}" method="POST" class="p-8"> 
            @csrf
            <div class="mb-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    @php
                        $fields = [
                            ...
                            ['name' => 'datapedia', 'label' => 'Datapedia (Whatssapp/Telepon)', 'class' => 'hitung-kunjungan'],
