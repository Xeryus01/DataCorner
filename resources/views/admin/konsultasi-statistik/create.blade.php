...
<div class="page-header-row">
    <div>
        <div class="page-title">Tambah Data Pengunjung Layanan Konsultasi Statistik</div>
        <div class="page-sub">Form input data pengunjung layanan konsultasi statistik</div>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        <div class="card-header-left">
            <div class="card-title"><i class="ti ti-handshake"></i>Form Statistik Konsultasi</div>
        </div>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('statistik.konsultasi-statistik.store') }}" method="POST">
            @csrf
            ...
            <div class="form-grid">
                @php
                    $fields = [
                        ['name' => 'konsultasi_online', 'label' => 'Konsultasi Online', 'class' => 'hitung-kunjungan'],
                        ['name' => 'kunjungan_langsung', 'label' => 'Kunjungan Langsung (Buku Tamu Akun PST Wilayah 1900)', 'class' => 'hitung-kunjungan'],
                        ['name' => 'datapedia', 'label' => 'Datapedia (Whatsapp/Telepon)', 'class' => 'hitung-kunjungan'],
                        ['name' => 'surat', 'label' => 'Surat (Internal/Eksternal)', 'class' => 'hitung-kunjungan'],
                    ];
                @endphp
            ...
            <div class="form-actions" style="justify-content:flex-end">
                <a href="{{ route('statistik.konsultasi-statistik.index') }}" class="btn-ghost">Batal</a>
