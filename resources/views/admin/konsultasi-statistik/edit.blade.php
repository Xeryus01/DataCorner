    ...
    <div class="w-full bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-blue-300 p-4">
            <h2 class="text-xl font-bold text-blue-800">
                Edit Data Pengunjung Layanan Konsultasi Statistik
            </h2>
            <p class="text-sm text-blue-700 mt-1">
                Ubah data pengunjung layanan konsultasi statistik.
            </p>
        </div>
        ...
        <form action="{{ route('statistik.konsultasi-statistik.update', $data->id) }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                @php
                    $fields = [
                        ['name'=>'konsultasi_online','label'=>'Konsultasi Online'],
                        ['name'=>'kunjungan_langsung','label'=>'Kunjungan Langsung (Buku Tamu Akun PST Wilayah 1900)'],
                        ['name'=>'datapedia','label'=>'Datapedia (Whatssapp/Telepon)'],
                        ['name'=>'surat','label'=>'Surat (Internal/Eksternal)'],
                ...
                <div>
                    ...
                    <input type="number" name="{{ $field['name'] }}" value="{{ old($field['name'], $data->{$field['name']}) }}"
                           class="w-full mt-1 p-2 border rounded" min="0">
                    @error($field['name'])
