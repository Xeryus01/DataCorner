    ...
    <div class="w-full bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="bg-blue-300 px-6 py-5">
            <h2 class="text-2xl font-bold text-blue-900">
                Tambah Data Pengunjung Website BPS Provinsi Kepulauan Bangka Belitung
            </h2>
            <p class="text-sm text-blue-800 mt-1">
                Form input data pengunjung Website BPS Provinsi Kepulauan Bangka Belitung.
            </p>
        </div>

        <form action="{{ route('statistik.website.store') }}" method="POST" class="p-8"> 
            @csrf
            <div class="mb-10">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    @php
                        $fields = [                            
                            ['name' => 'active_users', 'label' => 'Active Users', 'class' => ''],
                            ['name' => 'new_users', 'label' => 'New Users', 'class' => ''],
                            ['name' => 'returning_users', 'label' => 'Returning Users', 'class' => ''],
                            ['name' => 'total_users', 'label' => 'Total Users', 'class' => ''],
                            ['name' => 'sessions', 'label' => 'Sessions', 'class' => ''],
                            ['name' => 'bounce_rate', 'label' => 'Bounce Rate', 'class' => ''],
                        ];
                    @endphp
                    ...
                    <div>
                        ...
                        @if($field['name'] == 'bounce_rate')

                            <input type="text" name="{{ $field['name'] }}" value="{{ old($field['name'], 0) }}" placeholder="Contoh: 0,105201"
                                class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:border-blue-400 focus:ring-4 focus:ring-blue-50 transition-all duration-200 outline-none"
                                required>
                        @else
