...
<div class="card" style="max-width:600px">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('statistik.produk-statistik.update', $data->id) }}" method="POST">
            ...
            @php $fields=[['name'=>'pemohon_nol_rupiah','label'=>'Pemohon Nol Rupiah'],['name'=>'penjualan_produk_statistik_berbayar','label'=>'Penjualan Produk Statistik Berbayar'],['name'=>'penjualan_peta','label'=>'Penjualan Peta'],['name'=>'publikasi_elektronik','label'=>'Publikasi Elektronik']]; @endphp
