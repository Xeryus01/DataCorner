    ...
    <div class="w-full bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-blue-300 p-4">
            <h2 class="text-xl font-bold text-blue-800">
                Edit Data Pengunjung Layanan Statistik Berbayar
            </h2>
            <p class="text-sm text-blue-700 mt-1">
                Ubah data pengunjung layanan statistik berbayar.
            </p>
        </div>
        ...
        <form action="{{ route('statistik.produk-statistik.update', $data->id) }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                @php
                    $fields = [
                        ['name'=>'pemohon_nol_rupiah','label'=>'Pemohon Nol Rupiah'],
                        ['name'=>'penjualan_data_mikro','label'=>'Penjualan Data Mikro'],
                        ['name'=>'penjualan_peta','label'=>'Penjualan Peta'],
                        ['name'=>'publikasi_elektronik','label'=>'Publikasi Elektronik'],                      
                    ];
                @endphp
