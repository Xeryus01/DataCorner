...
<div class="page-header-row">
    <div>
        <div class="page-title">Tambah Data Pengunjung Layanan Statistik Berbayar</div>
        <div class="page-sub">Form input data pengunjung layanan statistik berbayar</div>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        <div class="card-header-left">
            <div class="card-title"><i class="ti ti-box"></i>Form Statistik Produk</div>
        </div>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('statistik.produk-statistik.store') }}" method="POST">
            @csrf
            ...
            <div class="form-actions" style="justify-content:flex-end">
                <a href="{{ route('statistik.produk-statistik.index') }}" class="btn-ghost">Batal</a>
