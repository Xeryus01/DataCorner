    ...
    <div class="w-full bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="bg-blue-300 px-6 py-5">
            <h2 class="text-2xl font-bold text-blue-900">
                Tambah Data Pengunjung Layanan Statistik Berbayar
            </h2>
            <p class="text-sm text-blue-800 mt-1">
                Form input data pengunjung layanan statistik berbayar.
            </p>
        </div>

        <form action="{{ route('statistik.produk-statistik.store') }}" method="POST" class="p-8"> 
            @csrf
            <div class="mb-10">
