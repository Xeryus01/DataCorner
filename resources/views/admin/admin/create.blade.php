...
<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:4px">
    <div>
        ...
        <div style="font-size:16px;font-weight:600;color:#0f172a">Tambah Admin</div>
        <div style="font-size:12px;color:#64748b;margin-top:2px">Buat akun admin atau operator baru untuk mengakses panel</div>
    </div>
    <div>
...
<div class="card" style="background:#fff;border:0.5px solid #e2e8f0;border-radius:12px;overflow:hidden">
    ...
    {{-- Card Body --}}
    <form method="POST" action="{{ route('admin.store') }}" class="card-body" style="padding:20px" novalidate>
        @csrf
        ...
        <div class="form-grid">
            ...
            <div>
                ...
                <input type="text" id="nama" name="nama" class="form-input" placeholder="Masukkan nama" value="{{ old('nama') }}" required>
            </div>
        </div>
