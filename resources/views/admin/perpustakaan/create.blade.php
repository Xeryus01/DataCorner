    ...
    <div class="w-full bg-white rounded-2xl shadow-sm overflow-hidden">
        <div class="bg-blue-300 px-6 py-5">
            <h2 class="text-2xl font-bold text-blue-900">
                Tambah Data Pengunjung Layanan Perpustakaan
            </h2>
            <p class="text-sm text-blue-800 mt-1">
                Form input data statistik layanan perpustakaan.
            </p>
        </div>

        {{-- Form --}}
        <form action="{{ route('statistik.perpustakaan.store') }}"
              method="POST"
              class="p-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <input type="number"
                               id="jumlah"
                               class="w-full px-4 py-3 bg-blue-50 border border-blue-100 rounded-xl text-blue-700 font-bold outline-none cursor-not-allowed"
                               readonly>
                    </div>
                </div>
            </div>
