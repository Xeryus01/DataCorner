    ...
    <div class="w-full bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-blue-300 p-4">
            <h2 class="text-xl font-bold text-blue-800">
                Edit Statistik Perpustakaan
            </h2>
            <p class="text-sm text-blue-700 mt-1">
                Ubah data statistik layanan perpustakaan.
            </p>
        </div>

        {{-- Ambil bulan & tahun dari periode --}}
        @php
            [$tahun, $bulan] = explode('-', $data->periode);
        @endphp

        {{-- Form --}}
        <form action="{{ route('statistik.perpustakaan.update', $data->id) }}"
              method="POST"
              class="p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                @php
                    $fields = [
                        ['name'=>'pengunjung_unik','label'=>'Pengunjung Unik'],
                        ['name'=>'kunjungan','label'=>'Kunjungan'],
                        ['name'=>'rata_harian','label'=>'Rata-rata Harian'],
                        ['name'=>'layanan_tercetak','label'=>'Layanan Tercetak'],
                        ['name'=>'digilib_online','label'=>'Digilib Online'],
                    ];
                @endphp
