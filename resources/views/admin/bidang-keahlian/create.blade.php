...
<div class="w-full p-6 bg-gray-100 min-h-screen">
    <div class="w-full bg-white rounded-lg shadow-md overflow-hidden">
        <div class="bg-blue-300 p-4">
            <h2 class="text-xl font-bold text-blue-800">Tambah Bidang Keahlian</h2>
        </div>

        <form method="POST" action="{{ route('bidang-keahlian.store') }}" class="p-6">
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="text"
                       name="nama_bidang"
                       id="nama_bidang"
                       placeholder="Contoh: Data dan Statistik"
