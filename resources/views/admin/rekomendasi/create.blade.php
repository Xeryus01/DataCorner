...
<div class="page-header-row">
    <div>
        <div class="page-title">Tambah Data Pengguna Layanan Rekomendasi Statistik</div>
        <div class="page-sub">Form input data pengguna layanan rekomendasi statistik</div>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        <div class="card-header-left">
            <div class="card-title"><i class="ti ti-bulb"></i>Form Statistik Rekomendasi</div>
        </div>
    </div>
    <div class="card-body">
        @if($errors->any())
        ...
        <form action="{{ route('statistik.rekomendasi.store') }}" method="POST">
            @csrf
            ...
            <div class="form-grid">
                ...
                @endforeach
                <div>
                    <label class="form-label">Jumlah Rekomendasi yang Terbit</label>
                    <input type="number" id="jumlah" class="form-input readonly" readonly>
                </div>
            </div>

            <div class="form-actions" style="justify-content:flex-end">
                <a href="{{ route('statistik.rekomendasi.index') }}" class="btn-ghost">Batal</a>
