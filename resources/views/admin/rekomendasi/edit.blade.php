    ...
    <div class="w-full bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-blue-300 p-4">
            <h2 class="text-xl font-bold text-blue-800">
                Edit Data Pengunjung Layanan Rekomendasi Statistik
            </h2>
            <p class="text-sm text-blue-700 mt-1">
                Ubah data pengunjung layanan rekomendasi statistik.
            </p>
        </div>
        ...
        <form action="{{ route('statistik.rekomendasi.update', $data->id) }}" method="POST" class="p-6">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                @php
                    $fields = [
                        ...
                        ['name'=>'kompromin','label'=>'Kompromin'],
                        ['name'=>'opd','label'=>'OPD'],
